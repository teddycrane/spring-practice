...
public class UserController extends BaseController implements IUserController {
  ...
  @Override
  public User updateUser(UpdateUserRequest request, String authToken)
  ...
  @Override
  public Collection<User> searchUsers(String searchType, String searchValue)
  ...
  @Override
  public User createUserNoAuth(@Valid CreateUserRequest request)
      throws BadRequestException, DuplicateItemException {
