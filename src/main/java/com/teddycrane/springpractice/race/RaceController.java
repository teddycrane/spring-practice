...
public class RaceController extends BaseController implements IRaceController {
	 ...
	 * @throws BadRequestException    Thrown if the input parameters do not allow
	 *                                for the creation of the race
	...
	@Override
	public Race updateRace(UpdateRaceRequest request, String id)
	 ...
	 * @throws BadRequestException Thrown if the racer is unable to be added to the
	 *                             Race object
	 */
	@Override
	...
	public Race setRacerResult(String raceId, SetResultRequest request)
		...
		try {
			...
			this.logger.error("Unable to parse one of the ids  raceId: {}, racerId: {}", raceId,
					Arrays.toString(request.getIds()));
			throw new BadRequestException(String.format("Unable to parse one of the ids  raceId: %s, racerId: %s",
