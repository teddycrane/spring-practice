...
public class RaceService extends BaseService implements IRaceService {
  ...
  @Override
  public Race updateRace(UUID id, String name, Category category)
      throws UpdateException, RaceNotFoundException, DuplicateItemException {
  ...
  @Override
  public Race addRacer(UUID id, List<UUID> racerIds)
      throws RacerNotFoundException, RaceNotFoundException, UpdateException {
