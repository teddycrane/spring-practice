...
public class UserServiceTest {
    ...
    @Captor
    private ArgumentCaptor<String> originalPasswordCaptor;
    @Captor
    ...
    public void shouldThrowErrorIfUserDoesNotExist() {
        ...
        Assertions.assertThrows(UserNotFoundError.class, () -> this.userService.getUser(UUID.randomUUID()));
    }
    ...
    public void shouldCreateUser() {
        ...
        User result = this.userService.createUser("firstName", "lastName", "username", "email@email.com", "password",
    ...
    public void shouldHandleUserCollisions() {
        ...
        Assertions.assertThrows(DuplicateItemException.class, () -> this.userService.createUser(existing.getFirstName(),
                existing.getLastName(), existing.getUsername(), existing.getPassword(), existing.getEmail(),
                Optional.empty()));
    }
    ...
    public void shouldAllowUserUpdatesWithAllFields() {
        ...
        try {
            User result = this.userService.updateUser(id, Optional.of("newUserName"), Optional.of("newPassword"),
                    Optional.of("newFirstName"), Optional.of("newLastName"), Optional.of("newEmail@email.com"),
    ...
    public void shouldNotUpdateIfNoUserIsFound() {
        ...
        Assertions.assertThrows(UserNotFoundError.class,
                () -> this.userService.updateUser(UUID.randomUUID(),
    ...
    public void shouldThrowErrorIfResettingPasswordForNonExistentUser() {
        ...
        Assertions.assertThrows(UserNotFoundError.class, () -> this.userService.resetPassword(UUID.randomUUID()));
    }
}
